    ...
    public partial class frmHastaKayıt : Form
    {
        ...
        private void btnKayıt_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlCommand komut = new SqlCommand("insert into tbl_Hasta (HastaAd,HastaSoyad,HastaTC,HastaTelefon,HastaSifre,HastaCinsiyet)values (@p1,@p2,@p3,@p4,@p5,@p6)", bgl.baglanti()))
                {
